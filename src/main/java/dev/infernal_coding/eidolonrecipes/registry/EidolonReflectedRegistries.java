...
public class EidolonReflectedRegistries {
    ...
    private static void reloadCodexChapters(RecipeManager manager) {
        ...
        Optional<BlastingRecipe> blastPewterIngot = Optional.ofNullable(blastingRecipes.get(new ResourceLocation(Eidolon.MODID, "smelt_pewter_blend")));
        ...
        Optional<CrucibleRecipe> arcaneGold = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "arcane_gold_ingot_alchemy")));
        ...
        crucibleRecipes.remove(new ResourceLocation(Eidolon.MODID, "arcane_gold_ingot_alchemy"));
        ...
        Optional<CrucibleRecipe> leather = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "flesh_to_leather")));
        ...
        Optional<CrucibleRecipe> rottenBeef = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "beef_to_flesh")));
        ...
        Optional<CrucibleRecipe> gunpowder = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "gunpowder_alchemy")));
        ...
        Optional<CrucibleRecipe> goldenApple = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "gilding_apple")));
        ...
        Optional<CrucibleRecipe> goldCarrot = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "gilding_carrot")));
        ...
        Optional<CrucibleRecipe> gildedMelon = Optional.ofNullable(crucibleRecipes.get(new ResourceLocation(Eidolon.MODID, "gilding_melon")));
